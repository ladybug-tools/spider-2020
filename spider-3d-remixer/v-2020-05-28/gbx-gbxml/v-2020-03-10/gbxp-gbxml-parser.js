...
GBX.init = function () {
	...
	window.addEventListener( "onloadFileXml", GBX.onLoad, false );
...
GBX.addMeshes = function ( meshes ) {
	...
	THR.bbox = new THREE.Box3().setFromObject( THR.gbx );

	//console.log( '', THR.bbox );
	...
	const htm = `
surfaces: ${ THR.gbx.children.length }</br>
