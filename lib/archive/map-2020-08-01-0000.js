...
MAP.getUrlGoogle = ( x, y ) => `${ MAP.mapOverlays[ MAP.overlayIndex ][ 1 ]}${ MAP.tileStartX + x }&y=${ MAP.tileStartY + y }&z=${ MAP.zoom }`;

MAP.getUrlEsri = ( x, y ) => `${ MAP.mapOverlays[ MAP.overlayIndex ][ 1 ] }${ MAP.zoom }/${ MAP.tileStartY + y }/${ MAP.tileStartX + x }.jpg`;

MAP.getUrlOsm = ( x, y ) => `${ MAP.mapOverlays[ MAP.overlayIndex ][ 1 ] }${ MAP.zoom }/${ MAP.tileStartX + x }/${ MAP.tileStartY + y }.png?access_token=${ MAP.mbptoken }`;
