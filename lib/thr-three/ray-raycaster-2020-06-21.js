...
RAY.getHtm = function (intersected) {
	...
	`<br>Census tract map: <a href="https://data.census.gov/cedsci/map?tid=GOVSTIMESERIES.CG00ORG01&mode=selection&g=1400000US06${ lines[ index ][ 0 ] }&vintage=2018&layer=VT_2018_140_00_PY_D1" target="_blank">${ lines[ index ][ 0 ] }</a> `;
