...
FOP.init = function () {
    ...
    window.addEventListener("hashchange", FOP.onHashChange);

}


FOP.onHashChange = function() {
	...
	FO.requestFile(url, FOP.onLoadJson);
}


FOP.onLoadJson = function ( xhr ) {

	json = xhr.target.response
	console.log( 'const', json);
