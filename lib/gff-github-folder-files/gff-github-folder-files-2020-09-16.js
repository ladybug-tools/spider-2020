...
GFF.items = [
	...
	},
	{
		...
		"user": "ladybug-tools",
		"repo": "/3d-models",
		"pathRepo": "gbxml-sample-files/bimport/",
		"title": "BIMPort test cases",
		"subTitle":
			`Files from the
		<a href="https://bimport.buildsim.io/project.html/" target="_blank">BuildSim</a>.
...
GFF.callbackGitHubMenu = function ( xhr ) {
	...
	extension = GFF.items[ GFF.index ].extension
