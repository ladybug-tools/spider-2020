...
MAP.getTilesHeightMaps = function () {
	...
	for ( let x = 0; x < MAP.cols; x++ ) {
		...
		for ( let y = 0; y < MAP.rows; y++ ) {
			...
			const url = `https://api.mapbox.com/v4/mapbox.terrain-rgb/${ MAP.zoom }/${ MAP.tileStartX + x }/${ MAP.tileStartY + y }.pngraw?access_token=${ MAP.mbptoken }`;
