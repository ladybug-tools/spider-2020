...
GFD.getMenu = function() {
	...
	const htm = `
	<details ontoggle=GFD.getFileNames(); open>

		<summary>Dragonfly Schema sample files</summary>

		<p>
			A list of files from <a href="https://github.com/ladybug-tools/dragonfly-schema/tree/master/dragonfly_schema/samples" target="_blank">ladybug-tools
