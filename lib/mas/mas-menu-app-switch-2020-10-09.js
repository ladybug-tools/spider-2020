...
MAS.arrApps = [
	...
	{
		text: "Spider gbXML Viewer R12 'Aragog'", url: "https://ladybug.tools/spider/gbxml-viewer/",
		title: "A popular release"
	},
	{
		text: "Spider gbXML Viewer R14", url: "https://ladybug.tools/spider/gbxml-viewer/r14/aragog-shortcut.html",
		title: "An interesting release"
	},
	{
		text: "Spider gbXML Tools home page (2019)", url: "https://ladybug.tools/spider-gbxml-tools/",
		title: "Home page for tools to help you find, load, examine and edit gbXML files - in large numbers and sizes"
	},
	{
		text: "Spider gbXML Viewer v0.17 'Maevia'", url: "https://ladybug.tools/spider-gbxml-tools/spider-gbxml-viewer/",
		title: "Mission: run a series of basic checks on gbXML files to identify, report and help you fix any issues."
	},
	{
		text: "Spider 2020 home page", url: "https://ladybug.tools/spider-2020/",
		title: "Latest development release - still under development - may have issues"
	},
	{
		text: "Spider gbXML Viewer v-2020-xx beta", url: "https://ladybug.tools/spider-2020/spider-gbxml-viewer/",
		title: "Latest development release - still under development - may have issues"
	},
	{
		text: "Spider gbXML Fixer", url: "https://ladybug.tools/spider-2020/spider-gbxml-fixer/",
		title: "Scripts to help you load, manage and fix 3D issues in gbXML files"
	},
	{
		text: "Spider IDF|OSM Viewer", url: "https://ladybug.tools/spider-2020/spider-idf-viewer/",
		title: "Scripts to help you load and view NREL IDF and OSM files"
	},
	{
		text: "Spider Pollination Viewer", url: "https://ladybug.tools/spider-2020/spider-pollination-viewer/",
		title: "Scripts to help you load and view Honeybee JSON files"
	},
	{
	...
	{
		text: "Spider RAD viewer", url: "https://ladybug.tools/spider-2020/spider-rad-viewer/rad-viewer",
