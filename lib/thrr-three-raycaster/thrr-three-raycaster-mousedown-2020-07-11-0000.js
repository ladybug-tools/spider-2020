...
THRR.addMouseDown = function () {
	THR.renderer.domElement.addEventListener("mousedown", THRR.onMouseDown);
	THR.renderer.domElement.addEventListener("touchstart", THRR.onMouseDown);
	THR.renderer.domElement.addEventListener("touchmove", THRR.onMouseDown);
