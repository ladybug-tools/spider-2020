...
THRG.getMenu = function () {
	...
	const htm = `
<details id=THRGdet ontoggle=THRG.getFilesPnGThree();>
	...
	<summary>
		...
		<p>The current set of bitmap textures is a work in progress, Could be anything you want.</p>
		<p>Bitmap textures currently: all JPG files from <a href="https://github.com/mrdoob/three.js/tree/dev/examples/textures" target="_blank">Three.js/examples</a>
		</span></span>
	...
	<p title="">
		...
		<label>
			<input type=checkbox id=THRGchkGround onchange=THRG.toggleGroundHelper(); checked> ground
		</label>
	</p>
...
THRG.toggleGroundHelper = function ( position = THR.scene.position.clone(), elevation = -0.1 ) {
	...
	THR.groundHelper.visible = THRGchkGround.checked;
