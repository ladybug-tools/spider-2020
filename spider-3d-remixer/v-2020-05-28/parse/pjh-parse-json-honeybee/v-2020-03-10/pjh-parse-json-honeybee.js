...
PJH.init = function () {
	...
	window.addEventListener( "onloadFileJson", PJH.processJson, false );
...
PJH.processJson = function () {
	...
	PJH.group = new THREE.Group();

	THR.group.add( PJH.group );

	OM.objects.push( PJH.group );
	...
	OM.selected.push( PJH.group, THR.lines );
