...
PHJ.processJson = function ( json ) {
	...
	PHJ.Wall = new THREE.BufferGeometry();
	PHJ.Floor = new THREE.BufferGeometry();
	PHJ.RoofCeiling = new THREE.BufferGeometry();
	PHJ.AirBoundary = new THREE.BufferGeometry();
...
PHJ.parseShades = function ( shades ) {
	...
	console.log( "PHJ.geometryShade", PHJ.geometryShade );
	//PHJ.bufferGeometry = new THREE.BufferGeometry().fromGeometry( PHJ.geometryShade );

	PHJ.bufferGeometry = PHJ.geometryShade;
