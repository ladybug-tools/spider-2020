...
JTV.init = function () {
	...
	<details id=JTVdetJsonTreeView open>
		...
		<summary class="summary-secondary" >
			...
			<span class="infoTooltip gmd-5">
				Display the entire contents of a JSON data in an easy to navigate user experience.
			</span></span>			
		
		</summary>

		<div id=JTVdivJsonHTML >
		
			<p><button onclick="JTVdivJsonHTML.innerHTML=JTV.parseJson( JTV.root, JTV.json, 0);JTV.showJson()" >parse data to JSON</button></p>
		
			<p>This operation can take a while on large files</p>
